        ...
        <flux:navbar class="max-lg:hidden">
            ...
            <flux:dropdown>
                ...
                <flux:navmenu>
                    ...
                    <flux:navmenu.item icon="plus-circle" href="#">Nouveau départ</flux:navmenu.item>
            ...
            <flux:dropdown>
                ...
                <flux:navmenu>
                    ...
                    <flux:navmenu.item icon="arrows-right-left" href="#">Trajets</flux:navmenu.item>
        ...
        <flux:dropdown class="lg:hidden" align="end">
            ...
            <flux:menu>
                ...
                <flux:menu.group heading="Départs">
                    ...
                    <flux:menu.item icon="plus-circle" href="#">Nouveau départ</flux:menu.item>
                ...
                <flux:menu.group heading="Admin">
                    ...
                    <flux:menu.item icon="arrows-right-left" href="#">Trajets</flux:menu.item>
